...
7. note: 编译目录不要有特殊字符。配置有问题参考：[地址]([https://learnopengl-cn.github.io/01%20Getting%20started/02%20Creating%20a%20window/#glfw_1](https://learnopengl-cn.github.io/01 Getting started/02 Creating a window/#glfw_1))。
